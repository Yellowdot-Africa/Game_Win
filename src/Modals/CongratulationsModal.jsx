    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-[#070E3C] px-6 py-10 border border-[#16D1F9] rounded-[20px] shadow-box-shadow max-w-sm w-full  mx-4">
        ...
        <p className="text-center mb-6 leading-[19.88px] text-[14px] font-normal font-alien">
          ...
          <br />
          PLAY MORE TO INCREASE YOUR CHANCES OF WINNING!
        </p>
        <p className="text-center mb-6 text-[14px] leading-[19.2px] font-normal font-alien">
        ...
        <div className="flex flex-col justify-center ">
          ...
          <button
            onClick={onHome}
            className="px-4 py-3.5 border border-[#16D1F9] text-[14px] font-bold leading-[16.8px] text-center font-alien text-white rounded-[24px] transition mt-6"
          >
            Home
          </button>
          <button
